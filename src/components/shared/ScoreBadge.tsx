...
export default function ScoreBadge({
  ...
  const config = BAND_CONFIG[band] || { label: band || 'N/A', bg: 'bg-slate-100 dark:bg-slate-800 dark:bg-slate-800', text: 'text-slate-600 dark:text-slate-300 dark:text-slate-300', border: 'border-slate-300 dark:border-slate-600 dark:border-slate-600' };
