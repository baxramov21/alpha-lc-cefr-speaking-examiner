...
export default function ReadingSetupPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 dark:bg-slate-950 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto w-full">
        <div className="bg-white dark:bg-slate-900 dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-700 dark:border-slate-700 overflow-hidden">
          ...
          {/* Body */}
          <div className="p-8">
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-200 dark:text-slate-200 mb-6 flex items-center gap-2">
              <FileText className="w-6 h-6 text-fuchsia-600" /> Test Instructions
            </h2>
            
            <div className="space-y-6">
              <div className="bg-slate-50 dark:bg-slate-950 dark:bg-slate-950 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 dark:border-slate-800">
                <h3 className="font-semibold text-slate-800 dark:text-slate-200 dark:text-slate-200 mb-2">Important Test Rules:</h3>
                <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 dark:text-slate-300 space-y-2">
              ...
              {isLoadingTasks ? (
                <div className="flex flex-col items-center justify-center p-8 bg-slate-50 dark:bg-slate-950 dark:bg-slate-950 rounded-2xl border border-slate-100 dark:border-slate-800 dark:border-slate-800">
                  <Loader2 className="w-8 h-8 text-fuchsia-500 animate-spin mb-4" />
                  <p className="text-slate-500 dark:text-slate-400 dark:text-slate-400 font-medium text-center">
                    Downloading reading materials securely...<br/>
                    <span className="text-sm">Please do not close this window.</span>
                  </p>
                </div>
              ) : (
                <div className="bg-emerald-50 dark:bg-emerald-950 dark:bg-emerald-950 p-6 rounded-2xl border border-emerald-100 flex items-center gap-4">
            ...
            <div className="mt-8 pt-8 border-t border-slate-100 dark:border-slate-800 dark:border-slate-800 flex justify-end">
              <Button 
                size="lg" 
