                  ...
                  <div key={q.id} className="group">
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        <div className="text-lg text-slate-800 dark:text-slate-200 dark:text-slate-200 font-medium mb-4" dangerouslySetInnerHTML={{ __html: q.text.replace(/<div[^>]*>\s*<img[^>]*src="\[UPLOAD_IMAGE_HERE\]"[^>]*>\s*<\/div>/g, '') }} />
