          ...
          <div className="p-8">
            ...
            <div className="space-y-6">
              <div className="bg-slate-50 dark:bg-slate-950 dark:bg-slate-950 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 dark:border-slate-800">
                <h3 className="font-semibold text-slate-800 dark:text-slate-200 dark:text-slate-200 mb-2">Important Playback Rules:</h3>
              ...
              <div className="bg-slate-50 dark:bg-slate-950 dark:bg-slate-950 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 dark:border-slate-800">
                <h3 className="font-semibold text-slate-800 dark:text-slate-200 dark:text-slate-200 mb-2">Test Format:</h3>
                <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 dark:text-slate-300 space-y-2">
            ...
            <div className="mt-10 border-t border-slate-100 dark:border-slate-800 dark:border-slate-800 pt-8 flex items-center justify-between">
